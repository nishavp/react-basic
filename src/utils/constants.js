//export multiple const from same files. Then use named export as below.
import menuItemImg from "../assets/images/menu-placeholder.png";
...
export const MENU_ITEM_PLACEHOLDER = menuItemImg;
